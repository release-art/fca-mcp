...
async def get_firm_adresses(
    frn: str, fca_client: fca_api.async_api.Client = deps.FcaApiDep
) -> fca_api.types.pagination.MultipageList[fca_api.types.firm.FirmAddress]:
...
async def get_firm_controlled_functions(
    frn: str, fca_client: fca_api.async_api.Client = deps.FcaApiDep
) -> fca_api.types.pagination.MultipageList[fca_api.types.firm.FirmControlledFunction]:
...
async def get_firm_individuals(
    frn: str, fca_client: fca_api.async_api.Client = deps.FcaApiDep
) -> fca_api.types.pagination.MultipageList[fca_api.types.firm.FirmIndividual]:
...
async def get_firm_permissions(
    frn: str, fca_client: fca_api.async_api.Client = deps.FcaApiDep
) -> fca_api.types.pagination.MultipageList[fca_api.types.firm.FirmPermission]:
...
async def get_firm_requirements(
    frn: str, fca_client: fca_api.async_api.Client = deps.FcaApiDep
) -> fca_api.types.pagination.MultipageList[fca_api.types.firm.FirmRequirement]:
...
async def get_firm_requirement_investment_types(
    frn: str, fca_client: fca_api.async_api.Client = deps.FcaApiDep
) -> fca_api.types.pagination.MultipageList[fca_api.types.firm.FirmRequirementInvestmentType]:
...
async def get_firm_regulators(
    frn: str, fca_client: fca_api.async_api.Client = deps.FcaApiDep
) -> fca_api.types.pagination.MultipageList[fca_api.types.firm.FirmRegulator]:
...
async def get_firm_passports(
    frn: str, fca_client: fca_api.async_api.Client = deps.FcaApiDep
) -> fca_api.types.pagination.MultipageList[fca_api.types.firm.FirmPassport]:
...
) -> fca_api.types.pagination.MultipageList[fca_api.types.firm.FirmPassportPermission]:
...
async def get_firm_waivers(
    frn: str, fca_client: fca_api.async_api.Client = deps.FcaApiDep
) -> fca_api.types.pagination.MultipageList[fca_api.types.firm.FirmWaiver]:
...
async def get_firm_exclusions(
    frn: str, fca_client: fca_api.async_api.Client = deps.FcaApiDep
) -> fca_api.types.pagination.MultipageList[fca_api.types.firm.FirmExclusion]:
    """"""
...
async def get_firm_disciplinary_history(
    frn: str, fca_client: fca_api.async_api.Client = deps.FcaApiDep
) -> fca_api.types.pagination.MultipageList[fca_api.types.firm.FirmDisciplinaryRecord]:
    """"""
...
async def get_firm_appointed_representatives(
    frn: str, fca_client: fca_api.async_api.Client = deps.FcaApiDep
) -> fca_api.types.pagination.MultipageList[fca_api.types.firm.FirmAppointedRepresentative]:
